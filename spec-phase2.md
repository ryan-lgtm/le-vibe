...
| **Single “Lé Vibe IDE” shell (Code OSS + branding)** | **`editor/`** — vendored when populated; interim **`LE_VIBE_EDITOR`** → **VSCodium**/system | **H6** — `docs/vscodium-fork-le-vibe.md`, **`editor/README.md`** |
