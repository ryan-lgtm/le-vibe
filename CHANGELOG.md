...
- **[`docs/ci-qa-hardening.md`](docs/ci-qa-hardening.md)** (*IDE smoke* — **`ci-smoke`** step 5 + **`editor/smoke.sh`** paragraph) and **[`.github/workflows/build-le-vibe-ide.yml`](.github/workflows/build-le-vibe-ide.yml)** job **Summary** cite **`build-linux.yml`** as the **`uses:`** alias.
