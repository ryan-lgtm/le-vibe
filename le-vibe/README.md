...
**Release channel / checksums (STEP 8 / H1):** Publishing **`le-vibe`** **`.deb`** beyond ad-hoc copies — [`../docs/apt-repo-releases.md`](../docs/apt-repo-releases.md) (**GitHub Actions** artifact **`le-vibe-deb`**, **`SHA256SUMS`**, optional **GitHub Releases**, optional **apt** hosting). Version source — [`../debian/changelog`](../debian/changelog); user-facing notes — [`../CHANGELOG.md`](../CHANGELOG.md). Workflow — [`../.github/workflows/ci.yml`](../.github/workflows/ci.yml). See [`../docs/PM_STAGE_MAP.md`](../docs/PM_STAGE_MAP.md) STEP **8**.
