...
**Brand assets (STEP 11 / H5):** Icon + screenshot handoff — [`../docs/brand-assets.md`](../docs/brand-assets.md); scalable app icon — [`../packaging/icons/hicolor/scalable/apps/le-vibe.svg`](../packaging/icons/hicolor/scalable/apps/le-vibe.svg). See [`../docs/PM_STAGE_MAP.md`](../docs/PM_STAGE_MAP.md) STEP **11**.
