...
- [x] `done` **task-n46-1**: **Extension README — `engines.vscode` minimum** — add one line (near **Prerequisites**) documenting the current minimum editor API baseline from **`package.json`** **`engines.vscode`** so contributors can see the runtime floor without scanning JSON; include contract test deriving the major/minor from **`engines.vscode`**.
  - Acceptance:
    - **`README.md`** + targeted test
    - **`npm run verify`** green
  - Evidence:
    - **`README.md`** — **`Editor API minimum (task-n46-1)`** with **`engines.vscode`** literal and **`1.85+`** floor.
    - **`test/readme-vscode-engine-min.test.js`**; **`npm run verify`** green.

### Epic N47 — Post-track continuity (engineering backlog)

- [x] `done` **task-n47-1**: **OPERATOR — README pointer for `engines.vscode` minimum** — under **`OPERATOR.md`** *Product track*, add one line cross-linking **`README.md`** *Editor API minimum (task-n46-1)* for **`package.json`** **`engines.vscode`** so operators align with **`task-n45-1`** doc-discovery pattern.
  - Acceptance:
    - **`OPERATOR.md`** + **`operator-doc.test.js`** token
    - **`npm run verify`** green
  - Evidence:
    - **`OPERATOR.md`** — **`README: engines.vscode minimum (task-n47-1)`** under *Product track*.
    - **`test/operator-doc.test.js`** — **`task-n47-1`** token test; **`npm run verify`** green.

### Epic N48 — Post-track continuity (engineering backlog)

- [x] `done` **task-n48-1**: **Extension README — `engines.node` minimum** — add one line (near **Prerequisites**) documenting **`package.json`** **`engines.node`** minimum so contributors can see the package-script runtime floor without scanning JSON; include contract test deriving the minimum major from **`engines.node`**.
  - Acceptance:
    - **`README.md`** + targeted test
    - **`npm run verify`** green
  - Evidence:
    - **`README.md`** — **`Node runtime minimum (task-n48-1)`** with **`engines.node`** literal and **`18+`** floor.
    - **`test/readme-node-engine-min.test.js`**; **`npm run verify`** green.
...
- [x] `done` **task-n52-1**: **Extension README — activationEvents command prefix example** — add one line near *Activation events (task-n50-1)* documenting one concrete **`onCommand:leVibeNative.*`** activation event literal from **`package.json`** so contributors can map the prefix pattern to a shipped command; include targeted contract test deriving that literal from **`package.json`**.
  - Acceptance:
    - **`README.md`** + targeted test
    - **`npm run verify`** green
  - Evidence:
    - **`README.md`** — **`Activation event example (task-n52-1)`** with concrete **`onCommand:leVibeNative.openAgentSurface`** literal.
    - **`test/readme-activation-events-command-example.test.js`**; **`npm run verify`** green.

### Epic N53 — Post-track continuity (engineering backlog)

- [x] `done` **task-n53-1**: **OPERATOR — README pointer for activationEvents command example** — under **`OPERATOR.md`** *Product track*, add one line cross-linking **`README.md`** *Activation event example (task-n52-1)* for **`package.json`** **`activationEvents`** so operators can find a concrete command-trigger literal without scanning JSON.
  - Acceptance:
    - **`OPERATOR.md`** + **`operator-doc.test.js`** token
    - **`npm run verify`** green
  - Evidence:
    - **`OPERATOR.md`** — **`README: activationEvents command example (task-n53-1)`** under *Product track*.
    - **`test/operator-doc.test.js`** — **`task-n53-1`** token test; **`npm run verify`** green.

### Epic N54 — Post-track continuity (engineering backlog)

- [x] `done` **task-n54-1**: **Extension README — activationEvents startup literal explanation** — add one line near activation docs clarifying why **`onStartupFinished`** is present in **`package.json`** **`activationEvents`** (readiness-first deterministic entry), with targeted contract test deriving the literal from **`package.json`**.
  - Acceptance:
    - **`README.md`** + targeted test
    - **`npm run verify`** green
  - Evidence:
    - **`README.md`** — **`Startup activation intent (task-n54-1)`** with **`onStartupFinished`** rationale.
    - **`test/readme-activation-events-startup-intent.test.js`**; **`npm run verify`** green.

### Epic N55 — Post-track continuity (engineering backlog)

- [x] `done` **task-n55-1**: **OPERATOR — README pointer for startup activation intent** — under **`OPERATOR.md`** *Product track*, add one line cross-linking **`README.md`** *Startup activation intent (task-n54-1)* for **`package.json`** **`activationEvents`** so operators can quickly verify why startup activation is enabled.
  - Acceptance:
    - **`OPERATOR.md`** + **`operator-doc.test.js`** token
    - **`npm run verify`** green
  - Evidence:
    - **`OPERATOR.md`** — **`README: startup activation intent (task-n55-1)`** under *Product track*.
    - **`test/operator-doc.test.js`** — **`task-n55-1`** token test; **`npm run verify`** green.

### Epic N56 — Post-track continuity (engineering backlog)

- [x] `done` **task-n56-1**: **Extension README — activation event example links to command table** — add one short line near *Activation event example (task-n52-1)* pointing to *Command palette and keyboard shortcuts (task-n17-1)* so readers can map the event literal to its palette label in one hop; include targeted contract test for both section tokens.
  - Acceptance:
    - **`README.md`** + targeted test
    - **`npm run verify`** green
  - Evidence:
    - **`README.md`** — **`Activation example lookup (task-n56-1)`** links activation event example to command table section.
    - **`test/readme-activation-event-command-table-link.test.js`**; **`npm run verify`** green.
...
- [x] `done` **task-n58-1**: **Extension README — activationEvents count breakdown pointer to startup line** — add one short line near *Activation events (task-n50-1)* pointing readers to *Startup activation intent (task-n54-1)* for rationale on the startup literal within the event count breakdown; include targeted test for both section tokens.
  - Acceptance:
    - **`README.md`** + targeted test
    - **`npm run verify`** green
  - Evidence:
    - **`README.md`** — **`Activation count rationale lookup (task-n58-1)`** links count breakdown context to startup rationale section.
    - **`test/readme-activation-count-startup-pointer.test.js`**; **`npm run verify`** green.

### Epic N59 — Post-track continuity (engineering backlog)

- [x] `done` **task-n59-1**: **OPERATOR — README pointer for activation count rationale lookup** — under **`OPERATOR.md`** *Product track*, add one line cross-linking **`README.md`** *Activation count rationale lookup (task-n58-1)* so operators can explain the startup-count relationship quickly.
  - Acceptance:
    - **`OPERATOR.md`** + **`operator-doc.test.js`** token
    - **`npm run verify`** green
  - Evidence:
    - **`OPERATOR.md`** — **`README: activation count rationale lookup (task-n59-1)`** under *Product track*.
    - **`test/operator-doc.test.js`** — **`task-n59-1`** token test; **`npm run verify`** green.
...
- [x] `done` **task-n61-1**: **OPERATOR — README pointer for activation docs sequence** — under **`OPERATOR.md`** *Product track*, add one line cross-linking **`README.md`** *Activation docs sequence (task-n60-1)* so operators can direct contributors through the intended activation doc flow quickly.
  - Acceptance:
    - **`OPERATOR.md`** + **`operator-doc.test.js`** token
    - **`npm run verify`** green
  - Evidence:
    - **`OPERATOR.md`** — **`README: activation docs sequence (task-n61-1)`** under *Product track*.
    - **`test/operator-doc.test.js`** — **`task-n61-1`** token test; **`npm run verify`** green.
...
- [x] `done` **task-n63-1**: **OPERATOR — README pointer for activation docs quick index** — under **`OPERATOR.md`** *Product track*, add one line cross-linking **`README.md`** *Activation docs quick index (task-n62-1)* so operators can send contributors to the activation doc cluster entrypoint first.
  - Acceptance:
    - **`OPERATOR.md`** + **`operator-doc.test.js`** token
    - **`npm run verify`** green
  - Evidence:
    - **`OPERATOR.md`** — **`README: activation docs quick index (task-n63-1)`** under *Product track*.
    - **`test/operator-doc.test.js`** — **`task-n63-1`** token test; **`npm run verify`** green.
...
- [x] `done` **task-n65-1**: **OPERATOR — README pointer for activation index next hop** — under **`OPERATOR.md`** *Product track*, add one line cross-linking **`README.md`** *Activation index next hop (task-n64-1)* so operators can point contributors from index to sequence quickly.
  - Acceptance:
    - **`OPERATOR.md`** + **`operator-doc.test.js`** token
    - **`npm run verify`** green
  - Evidence:
    - **`OPERATOR.md`** — **`README: activation index next hop (task-n65-1)`** under *Product track*.
    - **`test/operator-doc.test.js`** — **`task-n65-1`** token test; **`npm run verify`** green.

### Epic N66 — Post-track continuity (engineering backlog)

- [x] `done` **task-n66-1**: **Extension README — activation docs quick index references sequence token** — add one short parenthetical on *Activation docs quick index (task-n62-1)* explicitly naming *Activation docs sequence (task-n60-1)* so the index line itself carries the next-step token; include targeted token test.
  - Acceptance:
    - **`README.md`** + targeted test
    - **`npm run verify`** green
  - Evidence:
    - **`README.md`** — **`Activation docs quick index (task-n62-1)`** now explicitly names **`Activation docs sequence (task-n60-1)`**.
    - **`test/readme-activation-quick-index-sequence-token.test.js`**; **`npm run verify`** green.

### Epic N67 — Post-track continuity (engineering backlog)

- [x] `done` **task-n67-1**: **OPERATOR — README pointer for quick-index sequence token** — under **`OPERATOR.md`** *Product track*, add one line cross-linking **`README.md`** *Activation docs quick index (task-n62-1)* and noting it explicitly references *Activation docs sequence (task-n60-1)* so operators can call out the built-in next step.
  - Acceptance:
    - **`OPERATOR.md`** + **`operator-doc.test.js`** token
    - **`npm run verify`** green
  - Evidence:
    - **`OPERATOR.md`** — **`README: quick-index sequence token (task-n67-1)`** under *Product track*.
    - **`test/operator-doc.test.js`** — **`task-n67-1`** token test; **`npm run verify`** green.
...
- [x] `done` **task-n69-1**: **OPERATOR — README pointer for activation sequence return hop** — under **`OPERATOR.md`** *Product track*, add one line pointing to **`README.md`** *Activation sequence return hop (task-n68-1)* so operators can guide contributors back to the activation quick index from sequence context.
  - Acceptance:
    - **`OPERATOR.md`** + **`operator-doc.test.js`** token
    - **`npm run verify`** green
  - Evidence:
    - **`OPERATOR.md`** — **`README: activation sequence return hop (task-n69-1)`** under *Product track*.
    - **`test/operator-doc.test.js`** — **`task-n69-1`** token test; **`npm run verify`** green.
