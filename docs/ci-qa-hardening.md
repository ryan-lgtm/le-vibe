...
- **[`build-le-vibe-ide.yml`](../.github/workflows/build-le-vibe-ide.yml)** — **H6** dedicated workflow (**`editor/**`** PRs, metadata artifacts, **Summary** **Pre-binary artifact** / **`LE_VIBE_EDITOR`**); same **`ci-editor-gate`** as **`ci-smoke.sh`** / **`./editor/smoke.sh`**
