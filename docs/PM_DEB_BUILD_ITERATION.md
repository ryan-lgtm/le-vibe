...
**Sibling docs:** [`packaging/debian-le-vibe-ide/README.md`](../packaging/debian-le-vibe-ide/README.md), root [`debian/`](../debian/) (stack), [`editor/BUILD.md`](../editor/BUILD.md), **[`docs/PRODUCT_SPEC_SECTION8_EVIDENCE.md`](../docs/PRODUCT_SPEC_SECTION8_EVIDENCE.md)** (E1 audit / *Last verified* when packaging or release copy shifts), **[`docs/apt-repo-releases.md`](../docs/apt-repo-releases.md)** (H1 / STEP 8 — *Related docs* lists **`PRODUCT_SPEC_SECTION8_EVIDENCE.md`**, **`PM_DEB_BUILD_ITERATION.md`**, **`PM_STAGE_MAP.md`** next to **`ci-qa-hardening.md`**).

**Release checklist (H1):** After you bump **`debian/changelog`** / **[`CHANGELOG.md`](../CHANGELOG.md)** and want a **stack-only** GitHub Release (artifact **`le-vibe-deb`**, **`gh release create`**, **`SHA256SUMS`** verify) — follow **[`apt-repo-releases.md`](apt-repo-releases.md)** *Checklist — stack-only GitHub Release*. Full-product drops that add **`le-vibe-ide_*_amd64.deb`** use the same doc (*Pre-publish* / *Combined drop*).
