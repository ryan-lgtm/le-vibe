...
**Phase 2 vs this tree:** Session manifests and agents apply to **workspace** **`.lvibe/`** and **Continue** in this document. The **Lé Vibe IDE** desktop shell (Code OSS / **VSCodium** build, CI, packaging) is owned under **`editor/`** — **[`editor/README.md`](../editor/README.md)**, **[`editor/BUILD.md`](../editor/BUILD.md)**, **[`docs/vscodium-fork-le-vibe.md`](vscodium-fork-le-vibe.md)** (**H6**); optional Flatpak/AppImage — **H7** — **[`spec-phase2.md`](../spec-phase2.md) §14**. PM epics that ship the **shell** alongside the stack should treat **`editor/`** work as **P0** with **`le-vibe/`** — local **H6** smoke (no Electron compile): **`./editor/smoke.sh`** from the monorepo root; stack vs IDE CI split — **[`docs/ci-qa-hardening.md`](ci-qa-hardening.md)** (*IDE smoke*).
