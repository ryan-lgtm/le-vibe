...
| **14 — H6 IDE** | [`vscodium-fork-le-vibe.md`](vscodium-fork-le-vibe.md), [`editor/README.md`](../editor/README.md), [`PRODUCT_SPEC.md`](PRODUCT_SPEC.md) *Prioritization* | Monorepo **`editor/`** — **spec-phase2.md** §2 |
