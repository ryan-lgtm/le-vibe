...
**Release bundles (H1 / STEP 8 vs STEP 14 / §7.3):** Default **`ci.yml`** artifact **`le-vibe-deb`** contains the stack **`le-vibe`** **`.deb`**, SBOM, and **`SHA256SUMS`** for those files — **not** **`le-vibe-ide_*_amd64.deb`**. Full-product publishes attach both — **`docs/apt-repo-releases.md`** (*IDE package*); **`docs/PM_STAGE_MAP.md`** (*H1 vs §7.3 .deb bundles*).
