...
**Partial VSCode-linux tree (missing `bin/codium`):** [`editor/BUILD.md`](../editor/BUILD.md) (*Partial tree*, **14.c**); **`./editor/print-built-codium-path.sh`**, **`./editor/print-vsbuild-codium-path.sh`**; [`PM_DEB_BUILD_ITERATION.md`](PM_DEB_BUILD_ITERATION.md) (*Partial VSCode-linux tree*); **`./packaging/scripts/build-le-vibe-ide-deb.sh --help`**; [`apt-repo-releases.md`](apt-repo-releases.md) (*IDE package* — *Incomplete Linux build*).
