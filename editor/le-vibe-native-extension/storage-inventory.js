 ...
 * Keep in sync with `chat-transcript.js` / `first-run-wizard.js` / `operator-handoff.js` / `third-party-migration.js` / `workspace-plan-exec.js` / `workspace-fs-ops-audit.js` / `terminal-command-audit.js`.
 */
