...
# STEP 14 / H6: after pytest, ci-editor-gate.sh (same gate as ./editor/smoke.sh, build-le-vibe-ide.yml, build-linux.yml alias). E1: test_product_spec_section8.py — PRODUCT_SPEC *Prioritization* (ide-ci-metadata.txt, Pre-binary artifact, editor/BUILD.md, editor/VENDORING.md); test_build_le_vibe_ide_workflow_contract.py — ide-ci-metadata + Summary; test_le_vibe_readme_e1_contract.py — le-vibe/README vs root E1.
set -euo pipefail
